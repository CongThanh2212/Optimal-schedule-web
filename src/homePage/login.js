...
class Login extends React.Component {
    ...
    forgotPassword() {
        this.props.changeInterfaceType('ForgotPassword');
    }
    ...
    */
    login(event) {
        ...
        let error = document.getElementsByClassName('errLogin')[0]; // span hiển thị lỗi
        if (!email || !password) {
        ...
        xmlHttp.onreadystatechange = function() {
            if (this.readyState === 4) {
                ...
                } else error.innerHTML = 'Incorrect account';
            }
        }
    ...
    render() {
        ...
        // UI đăng nhập
        return (
            <form className="form_main" onSubmit={this.login}>
                ...
                <div className="inputContainer">
                    ...
                    <input placeholder="Email" id="username" className="inputField" type="text"/>
                </div>
